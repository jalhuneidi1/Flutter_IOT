...
class Network{
private:
 FirebaseData fbdo; //include all data for cloud firestore, functions for session control
  FirebaseAuth auth; // supports firebase authntication
  FirebaseConfig config; //configurescfirebase functions, includes API key and callback functions
